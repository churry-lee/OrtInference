...
int main()
{
    ...
    constexpr int64_t width = 224; // 224
    constexpr int64_t height = 224; // 224
    constexpr int64_t numClasses = 1000;
    constexpr int64_t numInputElements = numChannels * height * width;


    const std::string imageFile = PROJECT_SRC_DIR + std::string("/images/dog.png");
    const std::string labelFile = PROJECT_SRC_DIR + std::string("/labels/imagenet_classes.txt");
    const std::string modelPath = PROJECT_SRC_DIR + std::string("/models/resnet50v2.onnx");
